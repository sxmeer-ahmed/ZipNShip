...
public class ZipNShipFile : IDisposable
{
    ...
    public MemoryStream _zipStream;
    ...
    private readonly Dictionary<string,long> _addedFiles = [];
    ...
    public string PushFile(string filePath)
    {
        ...
        if (_addedFiles.Keys.Contains(fileName) && !_allowDuplicacy)
